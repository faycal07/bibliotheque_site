 ...
 <div class="container-fluid m-0 p-0 mt-5 pt-2">
    ...
    <div class="containerq">
        <div class="sidebarq">
            ...
            <a href="#" onclick="showPage('catalogue')">Gestion de catalogue</a>
        ...
        <div class="contentq" id="cataloguePage">
            ...
            <form class="formq" id="catalogueForm">
                ...
                <label for="catalogueName">Nom:</label>
                <input type="text" id="catalogueName" name="catalogueName" required>

                <label for="catalogueDescription">Description:</label>
                <textarea style="resize: none;" id="catalogueDescription" name="catalogueDescription" rows="4" required></textarea>

                <button class="buttonq" type="button">Ajouter Catalogue</button>
                <button class="buttonq" type="button">Modifier Catalogue</button>
                <button class="buttonq" type="button">Supprimer Catalogue</button>
            </form>

            <!-- Table to Display List of Catalogues -->
            <h2>List des Catalogues</h2>
